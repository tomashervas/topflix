  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        ...
        <Link className="text-zinc-400 p-2 mr-6 rounded-xl border border-zinc-400 hover:text-zinc-100 hover:border-zinc-100" href={isMovie ? '/movies?sort_by_name=true' : '/tvshows?sort_by_name=true'}><FaSortAlphaDown size={20}/></Link>
      </div>
